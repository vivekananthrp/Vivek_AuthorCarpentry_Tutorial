...
title: Data Management Plan for the Study 'Do Reputable Open Access Journals Require
  Open Data Sharing'?
author: "R.P. Vivek-Ananth, `r params$institution`"
...
params:
  institution:
    choices:
    - International Center for Theoritical Physics
    ...
    input: select
    label: 'institution:'
    value: The Institute of Mathematical Sciences, Chennai
...
R.P. Vivek-Ananth, Ph.D. student, The Institute of Mathematical Sciences (IMSc), Chennai

Researcher ID

ORCID: [0000-0002-3232-3299](https://orcid.org/0000-0002-3232-3299)
...
*This data table was compiled using the DT package by @R-DT*
...
res <- orcid_bio(orcid = "0000-0002-3232-3299")
bio <- res$'0000-0002-3232-3299'$'content'
